...
import gps from "../assets/images/Delivery app for tracking order with GPS.png";
 ...
 <section className={styles.featureSection} id='features'>
      ...
      <div className={styles.featureContainer}>
        ...
        <div className={styles.imageContainer}>
          <img src={gps} alt="Tracking illustration" className={styles.image} width={400} height={400}/>
        </div>
      </div>
    </section>
